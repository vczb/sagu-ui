"use strict";(self.webpackChunksagu_ui=self.webpackChunksagu_ui||[]).push([[623],{"./src/packages/Switch/stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Customized:()=>Customized,Default:()=>Default,DefaultChecked:()=>DefaultChecked,Disabled:()=>Disabled,default:()=>stories});__webpack_require__("./node_modules/react/index.js");var TextContent=__webpack_require__("./src/packages/TextContent/index.tsx"),styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const Label=styled_components_browser_esm.Ay.label`
  ${({disabled})=>styled_components_browser_esm.AH`
    ...
    width: fit-content;
  `}
`,switchModifiers={small:()=>styled_components_browser_esm.AH`
    width: 2.8rem;
    height: 1.6rem;
    &:before {
      width: 1rem;
  ...
  ${({theme,colors,spanSize="large"})=>styled_components_browser_esm.AH`
    opacity: 0;
    position: absolute;
...
//# sourceMappingURL=Switch-stories.7dc8f089.iframe.bundle.js.map