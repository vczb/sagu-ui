"use strict";(self.webpackChunksagu_ui=self.webpackChunksagu_ui||[]).push([[455],{"./src/packages/Ribbon/stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Default:()=>Default,default:()=>stories});__webpack_require__("./node_modules/react/index.js");var styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const wrapperModifiers={color:(theme,color)=>styled_components_browser_esm.AH`
  ...
  `,normal:theme=>styled_components_browser_esm.AH`
  ...
  `,small:theme=>styled_components_browser_esm.AH`
  ...
  ${({theme,color,size})=>styled_components_browser_esm.AH`
    position: absolute;
...
//# sourceMappingURL=Ribbon-stories.8d7d9adc.iframe.bundle.js.map