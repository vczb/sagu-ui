"use strict";(self.webpackChunksagu_ui=self.webpackChunksagu_ui||[]).push([[625],{"./src/packages/ToolTip/stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Bottom:()=>Bottom,Default:()=>Default,Left:()=>Left,Right:()=>Right,Top:()=>Top,default:()=>stories});__webpack_require__("./node_modules/react/index.js");var styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const Wrapper=styled_components_browser_esm.ZP.div`
  position: relative;
  display: inline-block;
`,Content=styled_components_browser_esm.ZP.span`
  ${({theme,position})=>styled_components_browser_esm.iv`
    visibility: hidden;
    ...
    ${"top"===position&&styled_components_browser_esm.iv`
      bottom: calc(100% + ${theme.spacings.xsmall});
      left: 50%;
      transform: translateX(-50%);
    `}
    ${"bottom"===position&&styled_components_browser_esm.iv`
      top: calc(100% + ${theme.spacings.xsmall});
      left: 50%;
      transform: translateX(-50%);
    `}
    ${"left"===position&&styled_components_browser_esm.iv`
      top: 50%;
      right: calc(100% + ${theme.spacings.small});
      transform: translateY(-50%);
    `}
    ${"right"===position&&styled_components_browser_esm.iv`
      top: 50%;
...
//# sourceMappingURL=ToolTip-stories.95eb1217.iframe.bundle.js.map