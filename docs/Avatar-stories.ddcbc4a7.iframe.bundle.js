...
`},"./src/packages/Avatar/stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Default:()=>Default,default:()=>stories});__webpack_require__("./node_modules/react/index.js");var styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js"),animations=__webpack_require__("./src/animations/index.ts");const variantShape={circle:()=>styled_components_browser_esm.AH`
    border-radius: 50%;
  `,square:()=>styled_components_browser_esm.AH`
    border-radius: 0;
  `,rounded:theme=>styled_components_browser_esm.AH`
    border-radius: ${theme.border.radius};
  `},Wrapper=styled_components_browser_esm.Ay.div`
  ${({theme,size="medium",variant="circle"})=>styled_components_browser_esm.AH`
    border-radius: 50%;
    align-items: center;
